...
<head>        
        ...
        <!-- Favicon -->
        <link href="assets-public/images/favicon.ico" rel="icon" type="image/x-icon" />
        ...
        <link rel="stylesheet" type="text/css" href="assets-public/css/jquery.accordion.css">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="topbar-links">
                                                <a href="signin"><i class="fa fa-lock"></i>Login / Register</a>
                                                <span>|</span>
                                                <div class="header-cart dropdown">
                                                    ...
                                                    <div class="dropdown-menu cart-dropdown">
                                                        <ul>
                                                            <li class="clearfix">
                                                                <img src="assets-public/images/header-cart-image-01.jpg" alt="cart item" />
                                                                <div class="item-info">
                                                                    <div class="name">
                                                            ...
                                                            <li class="clearfix">
                                                                <img src="assets-public/images/header-cart-image-02.jpg" alt="cart item" />
                                                                <div class="item-info">
                                                                    <div class="name">
                                                                        <a href="#">The Great Gatsby</a>
                                                                    </div>
                                                            ...
                                                            <li class="clearfix">
                                                                <img src="assets-public/images/header-cart-image-03.jpg" alt="cart item" />
                                                                <div class="item-info">
                                                                    <div class="name">
                                                                        <a href="#">The Great Gatsby</a>
                                                                    </div>
                                                        ...
                                                        <div class="cart-buttons">
                                                            <a href="cart" class="btn btn-dark-gray">View Cart</a>
                                ...
                                <div class="navbar-collapse hidden-sm hidden-xs">
                                    <ul class="nav navbar-nav">
                                        <li class="dropdown active">
                                            <a data-toggle="dropdown" class="dropdown-toggle disabled" href="index-2">Home</a>
                                            <ul class="dropdown-menu">
                                                <li><a href="index-2">Home V1</a></li>
                                                <li><a href="home-v2">Home V2</a></li>
                                                <li><a href="home-v3">Home V3</a></li>
                                            </ul>
                                        </li>
                                        <li class="dropdown">
                                            <a data-toggle="dropdown" class="dropdown-toggle disabled" href="books-media-list-view">Books &amp; Media</a>
                                            <ul class="dropdown-menu">
                                                <li><a href="books-media-list-view">Books &amp; Media List View</a></li>
                                                <li><a href="books-media-gird-view-v1">Books &amp; Media Grid View V1</a></li>
                                                <li><a href="books-media-gird-view-v2">Books &amp; Media Grid View V2</a></li>
                                                <li><a href="books-media-detail-v1">Books &amp; Media Detail V1</a></li>
                                                <li><a href="books-media-detail-v2">Books &amp; Media Detail V2</a></li>
                                            </ul>
                                        </li>
                                        <li class="dropdown">
                                            <a data-toggle="dropdown" class="dropdown-toggle disabled" href="news-events-list-view">News &amp; Events</a>
                                            <ul class="dropdown-menu">
                                                <li><a href="news-events-list-view">News &amp; Events List View</a></li>
                                                <li><a href="news-events-detail">News &amp; Events Detail</a></li>
                                            </ul>
                                        </li>
                                        <li class="dropdown">
                                        ...
                                        <li class="dropdown">
                                            <a data-toggle="dropdown" class="dropdown-toggle disabled" href="blog">Blog</a>
                                            <ul class="dropdown-menu">
                                                <li><a href="blog">Blog Grid View</a></li>
                        ...
                        <div class="mobile-menu hidden-lg hidden-md">
                            ...
                            <div id="mobile-menu">
                                <ul>
                                    ...
                                    <li>
                                        <a href="books-media-list-view">Books &amp; Media</a>
                                        <ul>
                                            <li><a href="books-media-list-view">Books &amp; Media List View</a></li>
                                            <li><a href="books-media-gird-view-v1">Books &amp; Media Grid View V1</a></li>
                                            <li><a href="books-media-gird-view-v2">Books &amp; Media Grid View V2</a></li>
                                    ...
                                    <li>
                                        <a href="news-events-list-view">News &amp; Events</a>
                                        <ul>
                                            <li><a href="news-events-list-view">News &amp; Events List View</a></li>
                                            <li><a href="news-events-detail">News &amp; Events Detail</a></li>
                                        </ul>
                                ...
                                <section class="search-filters">
                                    <div class="container">
                                        <div class="filter-box">
                                            ...
                                            <form action="http://libraria.demo.presstigers.com/index" method="get">
                                ...
                                <div class="col-md-9 col-md-push-3">
                                        ...
                                        <div class="row">                                            
                                            ...
                                            <div class="col-md-3 col-sm-3 pull-right">
                                                <div class="filter-toggle">
                                                    <a href="books-media-gird-view-v1" class="active"><i class="glyphicon glyphicon-th-large"></i></a>
                                                    <a href="books-media-list-view"><i class="glyphicon glyphicon-th-list"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="books-gird">
                                        <ul>
                                            <li>
                                                <figure>
                                                    <img src="assets-public/images/books-media/gird-view/book-media-grid-01.jpg" alt="Book">
                                                    <figcaption>
                                                ...
                                                <div class="single-book-box">
                                                    <div class="post-detail">
                                                        ...
                                                        <header class="entry-header">
                                                            <h3 class="entry-title"><a href="books-media-detail-v1">The Great Gatsby</a></h3>
                                                            <ul>
                                                        ...
                                                        <footer class="entry-footer">
                                                            <a class="btn btn-primary" href="books-media-detail-v1">Read More</a>
                                                        </footer>
                                                    </div>
                                                </div>                                       
                                            </li>
                                            <li>
                                                <figure>                                                    
                                                    <img src="assets-public/images/books-media/gird-view/book-media-grid-02.jpg" alt="Book">
                                                    <figcaption>
                                                        <p><strong>The Great Gatsby</strong></p>
                                                        <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                                                    </figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <img src="assets-public/images/books-media/gird-view/book-media-grid-03.jpg" alt="Book">
                                                    <figcaption>
                                                        <p><strong>The Great Gatsby</strong></p>
                                                        <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                                                    </figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <img src="assets-public/images/books-media/gird-view/book-media-grid-04.jpg" alt="Book">
                                                    <figcaption>
                                                        <p><strong>The Great Gatsby</strong></p>
                                                        <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                                                    </figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <img src="assets-public/images/books-media/gird-view/book-media-grid-05.jpg" alt="Book">
                                                    <figcaption>
                                                        <p><strong>The Great Gatsby</strong></p>
                                                        <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                                                    </figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <img src="assets-public/images/books-media/gird-view/book-media-grid-06.jpg" alt="Book">
                                                    <figcaption>
                                                        <p><strong>The Great Gatsby</strong></p>
                                                        <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                                                    </figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <img src="assets-public/images/books-media/gird-view/book-media-grid-07.jpg" alt="Book">
                                                    <figcaption>
                                                        <p><strong>The Great Gatsby</strong></p>
                                                        <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                                                    </figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <img src="assets-public/images/books-media/gird-view/book-media-grid-08.jpg" alt="Book">
                                                    <figcaption>
                                                        <p><strong>The Great Gatsby</strong></p>
                                                        <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                                                    </figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <img src="assets-public/images/books-media/gird-view/book-media-grid-09.jpg" alt="Book">
                                                    <figcaption>
                                                        <p><strong>The Great Gatsby</strong></p>
                                                        <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                                                    </figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <img src="assets-public/images/books-media/gird-view/book-media-grid-10.jpg" alt="Book">
                                                    <figcaption>
                                                        <p><strong>The Great Gatsby</strong></p>
                                                        <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                                                    </figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <img src="assets-public/images/books-media/gird-view/book-media-grid-11.jpg" alt="Book">
                                                    <figcaption>
                                                        <p><strong>The Great Gatsby</strong></p>
                                                        <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                                                    </figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <img src="assets-public/images/books-media/gird-view/book-media-grid-12.jpg" alt="Book">
                                                    <figcaption>
                                                        <p><strong>The Great Gatsby</strong></p>
                                                        <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                                                    </figcaption>
                                    ...
                                    <aside id="secondary" class="sidebar widget-area" data-accordion-group>
                                        ...
                                        <div class="widget widget_recent_entries">
                                            ...
                                            <ul>
                                                <li>
                                                    <figure>
                                                        <img src="assets-public/images/order-item-01.jpg" alt="product" />
                                                    </figure>
                                                ...
                                                <li>
                                                    <figure>
                                                        <img src="assets-public/images/order-item-02.jpg" alt="product" />
                                                    </figure>
                                                    <a href="#">The Sonic Boom</a>
                                                    <span class="price"><strong>Author:</strong> F. Scott Fitzgerald</span>
                                                    <span><strong>ISBN:</strong> 978158157</span>
                                                ...
                                                <li>
                                                    <figure>
                                                        <img src="assets-public/images/order-item-03.jpg" alt="product" />
                                                    </figure>
                                                    <a href="#">The Sonic Boom</a>
                                                    <span class="price"><strong>Author:</strong> F. Scott Fitzgerald</span>
                                                    <span><strong>ISBN:</strong> 978158157</span>
                            ...
                            <div class="container">
                                ...
                                <div class="team-list">
                                    <div class="team-member">
                                        <figure>
                                            <img src="assets-public/images/books-media/staff-pick/staff-picks-01.jpg" alt="Staff Pick" />
                                        </figure>
                                        <div class="content-block">
                                            <div class="member-info">
                                                <div class="member-thumb">
                                                    <img src="assets-public/images/books-media/staff-pick/gail.jpg" alt="Katherine">
                                                </div>
                                    ...
                                    <div class="team-member">
                                        <figure>
                                            <img src="assets-public/images/books-media/staff-pick/staff-picks-02.jpg" alt="Staff Pick" />
                                        </figure>
                                        <div class="content-block">
                                            <div class="member-info">
                                                <div class="member-thumb">
                                                    <img src="assets-public/images/books-media/staff-pick/katherine.jpg" alt="Katherine">
                                                </div>
                                                <div class="member-content">
                                    ...
                                    <div class="team-member">
                                        <figure>
                                            <img src="assets-public/images/books-media/staff-pick/staff-picks-03.jpg" alt="Staff Pick" />
                                        </figure>
                                        <div class="content-block">
                                            <div class="member-info">
                                                <div class="member-thumb">
                                                    <img src="assets-public/images/books-media/staff-pick/chris.jpg" alt="Katherine">
                                                </div>
                                                <div class="member-content">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-9 pull-right">
                            <ul>
                                <li><a href="index-2">Home</a></li>
                                <li><a href="books-media-list-view">Books &amp; Media</a></li>
                                <li><a href="news-events-list-view">News &amp; Events</a></li>
