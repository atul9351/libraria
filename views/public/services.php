        ...
        <section class="page-banner services-banner">
            <div class="container">
                <div class="banner-header">
                    ...
                    <p class="lead">Services offered by our library.</p>
                </div>
                                        ...
                                        <ul>
                                            <li class="col-sm-3">
                                                <div class="fact-item icon-ebooks">
                                                    <div class="fact-icon">
                                                        <img src="assets-public/images/icon-ebooks.png" alt="" />
                                                    </div>
                                            ...
                                            <li class="col-sm-3">
                                                <div class="fact-item icon-eaudio">
                                                    <div class="fact-icon">
                                                        <img src="assets-public/images/icon-eaudio.png" alt="" />
                                                    </div>
                                            ...
                                            <li class="col-sm-3">
                                                <div class="fact-item icon-magazine">
                                                    <div class="fact-icon">
                                                        <img src="assets-public/images/icon-magazine.png" alt="" />
                                                    </div>
                                            ...
                                            <li class="col-sm-3">
                                                <div class="fact-item icon-videos">
                                                    <div class="fact-icon">
                                                        <img src="assets-public/images/icon-videos.png" alt="" />
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="company-detail bg-light margin-right">
                                                            ...
                                                            <span class="underline left"></span>
                                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur nec mauris a neque tincidunt iaculis. Sed tristique luctus sapien. Vestibulum arcu magna, ullamcorper quis porta ac, venenatis non ante. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Cras commodo sollicitudin felis vel porttitor. Quisque vitae egestas sapien.</p>
                                                            <a href="contact" class="btn btn-dark-gray">Make a request</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="owl-carousel">
                                        <div class="single-testimonial-box">
                                            <div class="top-portion">
                                                <img src="assets-public/images/testimonial-image-01.jpg" alt="Testimonial Image" />
                                        ...
                                        <div class="single-testimonial-box">
                                            <div class="top-portion">
                                                <img src="assets-public/images/testimonial-image-02.jpg" alt="Testimonial Image" />
                                                <div class="user-comment">
                                                    <div class="arrow-left"></div>
                                                    <blockquote cite="#">
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent urna magna, rhoncus eget commodo et, dignissim non nulla. Sed sit amet vestibulum ex. Donec dolor velit
                                ...
                                <div id="category-filter">
                                    <ul class="category-list">
                                        <li class="category-item">
                                            <figure>
                                                <img src="assets-public/images/category-filter/home-v1/category-filter-img-01.jpg" alt="New Releaase" />
                                        ...
                                        <li class="category-item">
                                            <figure>
                                                <img src="assets-public/images/category-filter/home-v1/category-filter-img-02.jpg" alt="New Releaase" />
                                                <figcaption class="bg-orange">
                                                    <div class="info-block">
                                                        <h4>The Great Gatsby</h4>
                                                        <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                                        ...
                                        <li class="category-item">
                                            <figure>
                                                <img src="assets-public/images/category-filter/home-v1/category-filter-img-03.jpg" alt="New Releaase" />
                                                <figcaption class="bg-orange">
                                                    <div class="info-block">
                                                        <h4>The Great Gatsby</h4>
                                                        <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                                        ...
                                        <li class="category-item">
                                            <figure>
                                                <img src="assets-public/images/category-filter/home-v1/category-filter-img-04.jpg" alt="New Releaase" />
                                                <figcaption class="bg-orange">
                                                    <div class="info-block">
                                                        <h4>The Great Gatsby</h4>
                                                        <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
