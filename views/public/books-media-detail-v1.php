...
<head>        
        ...
        <!-- Responsive Table -->
        <link rel="stylesheet" type="text/css" href="assets-public/css/responsivetable.css" />
                                    ...
                                    <div class="booksmedia-detail-box">
                                        <div class="single-book-box">                                                
                                            <div class="post-thumbnail">
                                                ...
                                                <img alt="Book" src="assets-public/images/books-media/list-view/book-media-01.jpg" />                                                    
                                            </div>
                                        ...
                                        <div class="booksmedia-fullwidth booksmedia-popular-list">
                                            ...
                                            <ul class="popular-items-detail-v1">
                                                <li>
                                                    ...
                                                    <figure>
                                                        <img src="assets-public/images/books-media/layout-3/books-media-layout3-01.jpg" alt="Book">
                                                        <figcaption>
                                                            <header>
                                                ...
                                                <li>
                                                    <div class="book-list-icon yellow-icon"></div>
                                                    <figure>
                                                        <img src="assets-public/images/books-media/layout-3/books-media-layout3-02.jpg" alt="Book">
                                                        <figcaption>
                                                            <header>
                                                                <h4><a href="#.">The Great Gatsby</a></h4>
                                                                <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                                                ...
                                                <li>
                                                    ...
                                                    <figure>
                                                        <img src="assets-public/images/books-media/layout-3/books-media-layout3-03.jpg" alt="Book">
                                                        <figcaption>
                                                            <header>
                                                                <h4><a href="#.">The Great Gatsby</a></h4>
                                                                <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
